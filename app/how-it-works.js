  ...
  return (
    <div className="how-it-work">
      ...
      <ul className="content-list">
        ...
        <li>
            <Image src={Arrow1} alt="" priority height={ScreenSize.width > 1023 ? auto : 141} width={ScreenSize.width > 1023 ? auto : 141}/>
        </li>
        <li>
        ...
        <li>
            <Image src={Arrow2} alt="" priority height={ScreenSize.width > 1023 ? auto : 141} width={ScreenSize.width > 1023 ? auto : 141} />
        </li>
        <li>
